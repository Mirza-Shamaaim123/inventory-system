...
<!-- Mirrored from dreamspos.dreamstechnologies.com/html/template/register.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 13 Oct 2025 11:08:23 GMT -->
...
<body class="account-page">
                    ...
                    <form action="https://dreamspos.dreamstechnologies.com/html/template/signin.html">
                        <div class="login-userset">
                            ...
                            <div class="signinform">
                                <h4>Already have an account ? <a href="signin.html" class="hover-a">Sign In Instead</a>
                                </h4>
                            </div>
    ...
    <!-- jQuery -->
    <script src="assets/js/jquery-3.7.1.min.js" type="46921e623244ff12dfe97efb-text/javascript"></script>

    <!-- Feather Icon JS -->
    <script src="assets/js/feather.min.js" type="46921e623244ff12dfe97efb-text/javascript"></script>

    <!-- Bootstrap Core JS -->
    <script src="assets/js/bootstrap.bundle.min.js" type="46921e623244ff12dfe97efb-text/javascript"></script>
