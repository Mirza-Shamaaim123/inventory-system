...
<!-- Mirrored from dreamspos.dreamstechnologies.com/html/template/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 13 Oct 2025 10:57:36 GMT -->
<head>
				...
				<div id="sidebar-menu" class="sidebar-menu">
					<ul>
						...
						<li class="submenu-open">
							...
							<ul>
								<li><a href="{{ route('home.product') }}"><i data-feather="box"></i><span>Products</span></a></li>
								<li><a href="{{ route('add.product') }}"><i class="ti ti-table-plus fs-16 me-2"></i><span>Create Product</span></a></li>
								<li><a href="{{ route('expired.product') }}"><i class="ti ti-progress-alert fs-16 me-2"></i><span>Expired Products</span></a></li>
								<li><a href="{{ route('stock.page') }}"><i class="ti ti-trending-up-2 fs-16 me-2"></i><span>Low Stocks</span></a></li>
