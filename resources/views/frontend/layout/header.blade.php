                    ...
                    <li class="nav-item dropdown has-arrow main-drop profile-nav">
                        ...
                        <div class="dropdown-menu menu-drop-user">
                            ...
                            <form action="{{ route('logout') }}" method="POST" class="d-inline">
                                @csrf
                                <button type="submit" class="dropdown-item logout pb-0 border-0 bg-transparent">
                ...
                <div id="sidebar-menu" class="sidebar-menu">
                    <ul>
                        ...
                        <li class="submenu-open">
                            ...
                            <ul>
                                <li><a href="{{ route('home.product') }}"><i
                                            data-feather="box"></i><span>Products</span></a></li>
                                <li><a href="{{ route('add.product') }}"><i
                                            class="ti ti-table-plus fs-16 me-2"></i><span>Create Product</span></a>
                                </li>
                                <li><a href="{{ route('expired.product') }}"><i
