													...
													<div class="mb-3">
														...
														<div class="row">
															<div class="col-lg-10 col-sm-10 col-10">
																<select class="form-select variant-select select-option" id="colorSelect">
																	<option >Choose</option>
																	<option >Color</option>
										...
										<div class="text-editor add-list add">
											<div class="col-lg-12">
												<div class="add-choosen">
													...
													<div class="phone-img">
														<img src="{{ asset('assets/img/products/phone-add-2.png') }}" alt="image">
														<a href="javascript:void(0);"><i data-feather="x" class="x-square-add remove-product"></i></a>
													</div>
		
													<div class="phone-img">
														<img src="{{ asset('assets/img/products/phone-add-1.png') }}" alt="image">
														<a href="javascript:void(0);"><i data-feather="x" class="x-square-add remove-product"></i></a>
													</div>
												</div>
											</div>
